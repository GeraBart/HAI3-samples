/**
 * acronisAnalytics Screenset IDs
 *
 ...
 */
export const ACRONIS_ANALYTICS_SCREENSET_ID = 'acronisAnalytics';

/**
 * Screen IDs
 * Used for: Screen routing, screen-level translations
 */
export const HOME_SCREEN_ID = 'acronisAnalytics';
export const EMPTY_DASHBOARD_SCREEN_ID = 'emptyDashboard';
