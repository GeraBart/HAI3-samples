...
const MOCK_WIDGETS: Widget[] = [
  {
    ...
    legend: [{ label: 'Success', value: 200, color: '#22c55e' }],
  },
  {
    id: 'data-1',
    type: 'status-chart',
    title: 'Data chart',
    data: { value: 200, total: 200, label: 'GB Total', color: '#3b82f6' },
    legend: [{ label: 'First', value: 10, color: '#3b82f6' }],
  },
  {
    id: 'status-2',
    type: 'status-chart',
  ...
  },
  {
    ...
    title: 'Activities',
    data: [
      { label: '1', value: 45, color: '#ef4444' },
      { label: '2', value: 55, color: '#f97316' },
      { label: '3', value: 50, color: '#eab308' },
      { label: '4', value: 35, color: '#22c55e' },
      { label: '5', value: 48, color: '#3b82f6' },
    ],
    showLegend: true,
    legendItems: [
